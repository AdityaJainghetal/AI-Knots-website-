...
//           <button
//             onClick={handleLike}
//             className="flex items-center gap-2 text-[#EFE5C8] hover:text-red-700 text-2xl font-medium transition-colors"
//           >
    ...
    >
      ...
      <main className="max-w-4xl mx-auto px-6 md:px-8 py-12 md:py-20 ">
        <div className="absolute bottom-0 left-0 right-0 p-6 mt-10 md:p-12 max-w-5xl mx-auto">
          ...
          <h1
            className={`text-4xl md:text-6xl pt-12  font-bold leading-tight tracking-tight${isDark ? "text-gray-400" : "text-gray-600"} mb-6`}
          >
            {post.title}
          </h1>
        </div>
